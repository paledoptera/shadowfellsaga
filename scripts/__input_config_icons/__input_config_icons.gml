...
.add("gamepad face south",        spr_gamepad_xbox_small_A)
.add("gamepad face east",		    spr_gamepad_xbox_small_B)
.add("gamepad face west",          spr_gamepad_xbox_small_X)
.add("gamepad face north",        spr_gamepad_xbox_small_Y)
.add("gamepad shoulder l",         spr_gamepad_xbox_small_LB)
.add("gamepad shoulder r",       spr_gamepad_xbox_small_RB)
.add("gamepad trigger l",             spr_gamepad_xbox_small_LT)
.add("gamepad trigger r",         spr_gamepad_xbox_small_RT)
.add("gamepad select",            spr_gamepad_xbox_small_view)
.add("gamepad start",              spr_gamepad_xbox_small_start)
.add("gamepad dpad left",         spr_gamepad_xbox_small_dpad_left)
.add("gamepad dpad right",         spr_gamepad_xbox_small_dpad_right)
.add("gamepad dpad up",		spr_gamepad_xbox_small_dpad_up)
.add("gamepad dpad down",         spr_gamepad_xbox_small_dpad_down)

.add("gamepad thumbstick l left",  spr_gamepad_xbox_small_dpad_left)
.add("gamepad thumbstick l right", spr_gamepad_xbox_small_dpad_right)
.add("gamepad thumbstick l up",    spr_gamepad_xbox_small_dpad_up)
.add("gamepad thumbstick l down",  spr_gamepad_xbox_small_dpad_down)
.add("gamepad thumbstick l click", "thumbstick l click")

.add("gamepad thumbstick r left",  spr_gamepad_xbox_small_dpad_left)
.add("gamepad thumbstick r right", spr_gamepad_xbox_small_dpad_right)
.add("gamepad thumbstick r up",    spr_gamepad_xbox_small_dpad_up)
.add("gamepad thumbstick r down",  spr_gamepad_xbox_small_dpad_down)
