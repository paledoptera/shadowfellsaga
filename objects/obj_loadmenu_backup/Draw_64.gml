		...
		switch(selection){
				...
				case 0:
						...
						if(!file_exists("file1")){
							...
							ini_read_string("Party","Name2","ERROR"),
						   ...
						   c_gray,_alpha,fnt_main)	
							...
							if(file_exists("file1")){
								ini_open("sfsaga.ini");
								var minutes = ini_read_real("World","MN2",0);
								var seconds = ini_read_real("World","SC2",0);
								var _dsec = "";
								if(seconds < 10)
			...
			event_user(1);
				...
				switch(saved){
					case 0:
						...
						str_set_loc("Load this file?","DEVICE_LOAD_MENU_REVISED_Draw_64_slash_0_0")
